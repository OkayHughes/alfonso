...
function sol = polyOptOld(intParams, polyName, tol)
...
% -------------------------------------------------------------------------
    ...
    %   Okay's note: Are they chebyshev, or lagrange interpolant?
    %   According to padua_square.m, it's product chebyshev polynomials
    gH_Params.P = P0;
